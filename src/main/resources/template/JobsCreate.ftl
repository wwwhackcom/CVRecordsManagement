        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
            ...
            <#escape x as x?html>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputCompanyID" name="CompanyID" placeholder="CompanyID" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputJobTitle">JobTitle </label>
                        <input type="text" class="form-control" id="inputJobTitle" name="JobTitle" placeholder="JobTitle" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputJobDescription">JobDescription </label>
                        <input type="text" class="form-control" id="inputJobDescription" name="JobDescription" placeholder="JobDescription" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputJobRequirement">JobRequirement </label>
                        <input type="text" class="form-control" id="inputJobRequirement" name="JobRequirement" placeholder="JobRequirement" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputJobType">JobType </label>
                        <input type="text" class="form-control" id="inputJobType" name="JobType" placeholder="JobType" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputJobCIty">JobCIty </label>
                        <input type="text" class="form-control" id="inputJobCIty" name="JobCIty" placeholder="JobCIty" value="Auckland" />
                    </div>
                    <div class="form-group">
                        <label for="inputJobSuburb">JobSuburb </label>
                        <input type="text" class="form-control" id="inputJobSuburb" name="JobSuburb" placeholder="JobSuburb" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputJobAddress">JobAddress </label>
                        <input type="text" class="form-control" id="inputJobAddress" name="JobAddress" placeholder="JobAddress" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputPublishDate">PublishDate </label>
                        <input type="text" class="form-control" id="inputPublishDate" name="PublishDate" placeholder="PublishDate" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputContactPerson">ContactPerson </label>
                        <input type="text" class="form-control" id="inputContactPerson" name="ContactPerson" placeholder="ContactPerson" value="" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputJobLink" name="JobLink" placeholder="JobLink" value="" />
                    </div>
            </#escape>
