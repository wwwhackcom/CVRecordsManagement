        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
            ...
            <#escape x as x?html>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputDescription" name="Description" placeholder="Description" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputCountry">Country </label>
                        <input type="text" class="form-control" id="inputCountry" name="Country" placeholder="Country" value="New Zealand" />
                    </div>
                    <div class="form-group">
                        <label for="inputCity">City </label>
                        <input type="text" class="form-control" id="inputCity" name="City" placeholder="City" value="Auckland" />
                    </div>
                    <div class="form-group">
                        <label for="inputSuburb">Suburb </label>
                        <input type="text" class="form-control" id="inputSuburb" name="Suburb" placeholder="Suburb" value="" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputZipcode" name="Zipcode" placeholder="Zipcode" value="" />
                    </div>
                    <div class="form-group">
