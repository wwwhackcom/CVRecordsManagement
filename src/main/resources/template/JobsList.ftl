            ...
            <div class="table-responsive">
                <table class="table table-condensed table-hover">
                    ...
                    <tr>
                            ...
                            <td ><#if row.companyID??>${row.companyID?c}</#if></td>
                            <td ><#if row.jobTitle??>${row.jobTitle}</#if></td>
                            <td ><#if row.jobType??>${row.jobType?c}</#if></td>
                            <td ><#if row.jobCIty??>${row.jobCIty}</#if></td>
                            <td ><#if row.jobSuburb??>${row.jobSuburb}</#if></td>
                            <td ><#if row.jobAddress??>${row.jobAddress}</#if></td>
                            <td ><#if row.publishDate??>${row.publishDate?date}</#if></td>
                            <td ><#if row.contactPerson??>${row.contactPerson}</#if></td>
                            <td ><#if row.phone??>${row.phone}</#if></td>
                            <td ><#if row.jobLink??>${row.jobLink}</#if></td>
