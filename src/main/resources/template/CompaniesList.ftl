            ...
            <div class="table-responsive">
                <table class="table table-condensed table-hover">
                    ...
                    <tr>
                            ...
                            <td ><#if row.name??>${row.name}</#if></td>
                            <td ><#if row.country??>${row.country}</#if></td>
                            <td ><#if row.city??>${row.city}</#if></td>
                            <td ><#if row.suburb??>${row.suburb}</#if></td>
                            <td ><#if row.address??>${row.address}</#if></td>
                            <td ><#if row.zipcode??>${row.zipcode?c}</#if></td>
