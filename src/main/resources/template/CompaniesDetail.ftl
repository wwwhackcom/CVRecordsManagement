    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="/p/Companies/list">Companies</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
            ...
            <#escape x as x?html>
                ...
                <div class="form-group">
                    ...
                    <input  type="text" class="form-control" id="inputName" name="Name" placeholder="Name" value="<#if row.name??>${row.name}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputDescription">Description </label>
                    <input  type="text" class="form-control" id="inputDescription" name="Description" placeholder="Description" value="<#if row.description??>${row.description}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputCountry">Country </label>
                    <input  type="text" class="form-control" id="inputCountry" name="Country" placeholder="Country" value="<#if row.country??>${row.country}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputCity">City </label>
                    <input  type="text" class="form-control" id="inputCity" name="City" placeholder="City" value="<#if row.city??>${row.city}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputSuburb">Suburb </label>
                    <input  type="text" class="form-control" id="inputSuburb" name="Suburb" placeholder="Suburb" value="<#if row.suburb??>${row.suburb}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputAddress">Address </label>
                    <input  type="text" class="form-control" id="inputAddress" name="Address" placeholder="Address" value="<#if row.address??>${row.address}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputZipcode">Zipcode </label>
                    <input  type="text" class="form-control" id="inputZipcode" name="Zipcode" placeholder="Zipcode" value="<#if row.zipcode??>${row.zipcode?c}</#if>">
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#confirmDelete").click(function(){
            ...
            $this.button('loading');
            $.ajax({
                url: "../../../companies/delete/" + $("#inputID").val(),
                type:"post",
                dataType:'text',
