        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
            ...
            <#escape x as x?html>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputUserID" name="UserID" placeholder="UserID" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputGender">Gender </label>
                        <input type="text" class="form-control" id="inputGender" name="Gender" placeholder="Gender" value="" />
                    </div>
                    <div class="form-group">
                        <label for="inputDOB">DOB </label>
                        <input type="text" class="form-control" id="inputDOB" name="DOB" placeholder="DOB" value="" />
                    </div>
            </#escape>
