        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
            ...
            <#escape x as x?html>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputPassword" name="Password" placeholder="Password" value="" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputContact" name="Contact" placeholder="Contact" value="" />
                    </div>
            </#escape>
