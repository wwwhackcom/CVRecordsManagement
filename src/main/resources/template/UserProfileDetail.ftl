    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="/p/UserProfile/list">UserProfile</a></li>
                <li><a href="/p/Users/list">Users</a></li>
            </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
            <h2 class="sub-header">UserProfile</h2>
            <#if row??>
            ...
            <#escape x as x?html>
                ...
                <div class="form-group">
                    ...
                    <input  type="text" class="form-control" id="inputUserID" name="UserID" placeholder="UserID" value="<#if row.userID??>${row.userID?c}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputGender">Gender </label>
                    <input  type="text" class="form-control" id="inputGender" name="Gender" placeholder="Gender" value="<#if row.gender??>${row.gender}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputDOB">DOB </label>
                    <input  type="text" class="form-control" id="inputDOB" name="DOB" placeholder="DOB" value="<#if row.dOB??>${row.dOB?date}</#if>">
                </div>
            </#escape>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#confirmDelete").click(function(){
            ...
            $this.button('loading');
            $.ajax({
                url: "../../../userProfile/delete/" + $("#inputID").val(),
                type:"post",
                dataType:'text',
