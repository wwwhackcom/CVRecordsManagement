        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
            ...
            <#escape x as x?html>
                ...
                <div class="form-group">
                    ...
                    <input  type="text" class="form-control" id="inputJobID" name="JobID" placeholder="JobID" value="<#if row.jobID??>${row.jobID?c}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputApplyDate">ApplyDate </label>
                    <input  type="text" class="form-control" id="inputApplyDate" name="ApplyDate" placeholder="ApplyDate" value="<#if row.applyDate??>${row.applyDate?date}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputStatus">Status </label>
                    <input  type="text" class="form-control" id="inputStatus" name="Status" placeholder="Status" value="<#if row.status??>${row.status?c}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputReplyDate">ReplyDate </label>
                    <input  type="text" class="form-control" id="inputReplyDate" name="ReplyDate" placeholder="ReplyDate" value="<#if row.replyDate??>${row.replyDate?date}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputReplyContent">ReplyContent </label>
                    <input  type="text" class="form-control" id="inputReplyContent" name="ReplyContent" placeholder="ReplyContent" value="<#if row.replyContent??>${row.replyContent}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputReplyPersonName">ReplyPersonName </label>
                    <input  type="text" class="form-control" id="inputReplyPersonName" name="ReplyPersonName" placeholder="ReplyPersonName" value="<#if row.replyPersonName??>${row.replyPersonName}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputReplyContact">ReplyContact </label>
                    <input  type="text" class="form-control" id="inputReplyContact" name="ReplyContact" placeholder="ReplyContact" value="<#if row.replyContact??>${row.replyContact}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputFurtherStep">FurtherStep </label>
                    <input  type="text" class="form-control" id="inputFurtherStep" name="FurtherStep" placeholder="FurtherStep" value="<#if row.furtherStep??>${row.furtherStep}</#if>">
                </div>
                <div class="form-group">
                    <label for="inputFutherCalendar">FutherCalendar </label>
                    <input  type="text" class="form-control" id="inputFutherCalendar" name="FutherCalendar" placeholder="FutherCalendar" value="<#if row.futherCalendar??>${row.futherCalendar?date}</#if>">
                </div>
            </#escape>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#confirmDelete").click(function(){
            ...
            $this.button('loading');
            $.ajax({
                url: "../../../applyRecords/delete/" + $("#inputID").val(),
                type:"post",
                dataType:'text',
